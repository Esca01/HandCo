...
import 'eps_model.dart';
export 'eps_model.dart';

class EpsWidget extends StatefulWidget {
  const EpsWidget({super.key});

  @override
  State<EpsWidget> createState() => _EpsWidgetState();
}

class _EpsWidgetState extends State<EpsWidget> with TickerProviderStateMixin {
  late EpsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EpsModel());
